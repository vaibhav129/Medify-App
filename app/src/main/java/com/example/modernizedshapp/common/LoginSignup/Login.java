...
public class Login extends AppCompatActivity {
    ...
    public void letUserLogIn(View view) {
        ...
        String _phoneNumberEnteredByUser = Objects.requireNonNull(mobileNumber.getEditText()).getText().toString().trim();
        final String _passwordNumberEnteredByUser = Objects.requireNonNull(password.getEditText()).getText().toString().trim();
        ...
        Query checkUser = FirebaseDatabase.getInstance("https://cellular-sylph-380317-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Registration").orderByChild("phoneNo").equalTo(_completePhoneNumber);
